  ...
  <div class="flex-1 flex flex-col justify-between min-w-0">
    <div>
      <a href="<?php $this->permalink() ?>" class="block group">
        ...
        <p class="text-sm sm:text-base text-gray-500 dark:text-gray-400 mb-3 sm:mb-4 line-clamp-2 sm:line-clamp-3 leading-relaxed post-excerpt">
          <?php $this->excerpt(200, '...'); ?>
        </p>
      </a>
    </div>
    <div class="flex flex-wrap items-center gap-3 sm:gap-4 text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 mt-auto post-meta">
